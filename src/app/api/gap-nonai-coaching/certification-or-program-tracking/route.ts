...
// Gap-nonai endpoint: Certification or program tracking
...
export async function POST(req: NextRequest) {
  try {
    ...
    await persist('certification-or-program-tracking', body, out);
    return NextResponse.json({ feature: 'certification-or-program-tracking', title: 'Certification or program tracking', result: out });
  } catch (err: any) {
