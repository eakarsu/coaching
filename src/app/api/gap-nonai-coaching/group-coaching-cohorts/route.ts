...
// Gap-nonai endpoint: Group coaching cohorts
...
export async function POST(req: NextRequest) {
  try {
    ...
    await persist('group-coaching-cohorts', body, out);
    return NextResponse.json({ feature: 'group-coaching-cohorts', title: 'Group coaching cohorts', result: out });
  } catch (err: any) {
