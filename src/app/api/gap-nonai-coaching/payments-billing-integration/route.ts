...
// Gap-nonai endpoint: Payments / billing integration
...
export async function POST(req: NextRequest) {
  try {
    ...
    await persist('payments-billing-integration', body, out);
    return NextResponse.json({ feature: 'payments-billing-integration', title: 'Payments / billing integration', result: out });
  } catch (err: any) {
