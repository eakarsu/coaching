...
// Gap-nonai endpoint: Notification preferences
...
export async function POST(req: NextRequest) {
  try {
    ...
    await persist('notification-preferences', body, out);
    return NextResponse.json({ feature: 'notification-preferences', title: 'Notification preferences', result: out });
  } catch (err: any) {
