...
// Gap-nonai endpoint: Video conferencing module (Zoom/Daily integration)
  ...
  try {
    ...
    const r = await fetch(OPENROUTER_URL, {
      ...
      body: JSON.stringify({ model: OPENROUTER_MODEL, messages: [
        ...
        { role: 'user', content: `Feature: Video conferencing module (Zoom/Daily integration)\nContext: ${JSON.stringify(body)}\nReturn JSON {"summary":"","key_points":[""],"recommendations":[""]}` }
    ...
    await persist('video-conferencing-module-zoomdaily-integration', body, out);
    return NextResponse.json({ feature: 'video-conferencing-module-zoomdaily-integration', title: 'Video conferencing module (Zoom/Daily integration)', result: out });
  } catch (err: any) {
