...
// Gap-ai endpoint: AI session summarization with action items
...
export async function POST(req: NextRequest) {
  try {
    ...
    await persist('ai-session-summarization-with-action-items', body, out);
    return NextResponse.json({ feature: 'ai-session-summarization-with-action-items', title: 'AI session summarization with action items', result: out });
  } catch (err: any) {
