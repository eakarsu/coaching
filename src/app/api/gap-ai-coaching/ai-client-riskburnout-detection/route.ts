...
// Gap-ai endpoint: AI client risk/burnout detection
...
export async function POST(req: NextRequest) {
  try {
    ...
    await persist('ai-client-riskburnout-detection', body, out);
    return NextResponse.json({ feature: 'ai-client-riskburnout-detection', title: 'AI client risk/burnout detection', result: out });
  } catch (err: any) {
