...
// Gap-ai endpoint: AI matching of coach to coachee
...
export async function POST(req: NextRequest) {
  try {
    ...
    await persist('ai-matching-of-coach-to-coachee', body, out);
    return NextResponse.json({ feature: 'ai-matching-of-coach-to-coachee', title: 'AI matching of coach to coachee', result: out });
  } catch (err: any) {
