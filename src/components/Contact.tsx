        ...
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          <div>
            ...
            <p className="text-xl text-gray-600 mb-10">
              Have questions about coaching or want to explore how we can work together? I'd love to hear from you.
            </p>
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <a href="mailto:hello@executivecoach.com" className="text-blue-600 hover:text-blue-700">
                    hello@executivecoach.com
                  </a>
                </div>
              </div>
            ...
            <div className="mt-10 pt-10 border-t border-gray-200">
              ...
              <div className="flex space-x-4">
                <a href="#" className="w-10 h-10 bg-gray-100 rounded-lg flex items-center justify-center text-gray-600 hover:bg-blue-100 hover:text-blue-600 transition-colors">
